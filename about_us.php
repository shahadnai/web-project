    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9 bg-white padding-2">
          ...
          <h2 style="color:#e23c89;">About Us: <h3 style="color:black;">We are students of the College of Computer Science and Information Technology. We created this website for the passion of programming and using our skills. The main goal is getting more experience.</h3></h2>
        </div>
      </div>
    </div>
  </section>
